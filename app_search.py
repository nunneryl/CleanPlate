# app_search.py - LIVE Production Version with Working Logic Restored
...
# --- CORRECT, SPACE-PRESERVING NORMALIZATION FUNCTION ---
...
# --- Search Endpoint (Restored from your live v1.2) ---
...
def search():
    ...
    # Check for synonyms by removing spaces from the search term for the lookup
    ...
    # This is the original, working query from your v1.2 app
    query = """
