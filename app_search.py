# In file: PREVIEW_app_search.py (Corrected - Removed mogrify)
...
# _execute_query: REMOVED the cursor.mogrify line
...
# AND includes the NEW enriched fields. (Keep as provided in last correct version)
...
def search_restaurants():
    ...
    final_params_list = []; final_params_list.extend(params_list); final_params_list.extend(sort_params_list)
    final_params_list.append(limit); final_params_list.append(offset); final_params_list.extend(params_list)
